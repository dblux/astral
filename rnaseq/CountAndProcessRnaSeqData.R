...
# load the libraries
libraries <- "reshape2,bernett,edgeR,futile.logger,rtracklayer,ggplot2,ggdendro,openxlsx,data.table,ggdendro,ggrepel,jsonlite"
...
d1 <- as.matrix(d1)
sampleNames <- gsub("\\.bam$", "", sampleNames)
